    ...
    <div className="mx-auto max-w-6xl w-full px-5 sm:px-8 py-10 sm:py-14">
      <div className="mb-8">
        ...
        <p className="text-muted mt-3 max-w-xl">
          Browse the current Shelfie below, then open any item to see its full
          spec sheet.
        </p>
      </div>
      ...
      {loadError ? (
        <div className="rounded-xl border border-dashed border-line bg-surface/50 px-6 py-16 text-center">
          <p className="font-display font-bold text-ink">
            The Shelfie didn&apos;t load
          </p>
          <p className="font-mono text-xs text-muted mt-1">
            The inventory API might be temporarily unavailable. Refresh to try
            again.
          </p>
        </div>
      ) : (
